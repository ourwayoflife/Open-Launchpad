...
function openlaunchpad_install_tasks_alter(&$tasks, $install_state) {
...
function install_auto_configure(&$install_state) {
  ...
  variable_set('site_name', st('Open Launchpad'));
...
function openlaunchpad_install_tasks(&$install_state) {
  $tasks['_openlaunchpad_install_other_modules'] = array(
    'display_name' => st('Install Other Open Launchpad Modules'),
    'display' => FALSE,
    'type' => 'normal',
    'run' => INSTALL_TASK_RUN_IF_NOT_COMPLETED,
  );
  
  $tasks['_openlaunchpad_load_basic_pages'] = array(
    'display_name' => st('Load Open Launchpad Basic Pages'),
    'display' => FALSE,
    'type' => 'normal',
    'run' => INSTALL_TASK_RUN_IF_NOT_COMPLETED,
  );  
 ...
 */
function openlaunchpad_form_install_configure_form_alter(&$form, $form_state) {
  // Pre-populate the site name with the server name.
  $form['site_information']['site_name']['#default_value'] = $_SERVER['SERVER_NAME'];
}
function _openlaunchpad_install_other_modules() {
...
function _openlaunchpad_load_basic_pages() {
  _openlaunchpad_add_node('About Us', 'Placeholder for About Us.', 1);
  _openlaunchpad_add_node('Terms of Service', 'Placeholder for Terms of Service.', 2);
  _openlaunchpad_add_node('Privacy', 'Placeholder for Privacy.', 3);
  _openlaunchpad_add_node('Contact Us', 'Placeholder for Contact Us.', 4);      
}
